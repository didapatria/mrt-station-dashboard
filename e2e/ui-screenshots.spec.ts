...
test.describe("UI Screenshots", () => {
  ...
  test("stations page", async ({ adminPage: page }) => {
    ...
    await page.screenshot({
      path: "playwright-report/screenshots/stations.png",
      fullPage: true,
    });
  });
  ...
  test("schedules page", async ({ adminPage: page }) => {
    ...
    await expect(page.locator("table").first()).toBeVisible();
    await page.screenshot({
      path: "playwright-report/screenshots/schedules.png",
      fullPage: true,
    });
  });
  ...
  test("station map page", async ({ adminPage: page }) => {
    ...
    await page.screenshot({
      path: "playwright-report/screenshots/map.png",
      fullPage: true,
    });
  });
  ...
  test("route planner page", async ({ adminPage: page }) => {
    ...
    await page.screenshot({
      path: "playwright-report/screenshots/route-planner.png",
      fullPage: true,
    });
  });
  ...
  test("station compare page", async ({ adminPage: page }) => {
    ...
    await page.screenshot({
      path: "playwright-report/screenshots/station-compare.png",
      fullPage: true,
    });
  });
  ...
  test("users page", async ({ adminPage: page }) => {
    ...
    await expect(page.locator("table").first()).toBeVisible();
    await page.screenshot({
      path: "playwright-report/screenshots/users.png",
      fullPage: true,
    });
  });
  ...
  test("access management page", async ({ adminPage: page }) => {
    ...
    await page.screenshot({
      path: "playwright-report/screenshots/access-management.png",
      fullPage: true,
    });
  });
  ...
  test("activity log page", async ({ adminPage: page }) => {
    ...
    await page.screenshot({
      path: "playwright-report/screenshots/activity-log.png",
      fullPage: true,
    });
  });
  ...
  test("settings page", async ({ adminPage: page }) => {
    ...
    await page.screenshot({
      path: "playwright-report/screenshots/settings.png",
      fullPage: true,
    });
  });
  ...
  test("profile page", async ({ adminPage: page }) => {
    ...
    await page.screenshot({
      path: "playwright-report/screenshots/profile.png",
      fullPage: true,
    });
  });
  ...
  test("changelog page", async ({ adminPage: page }) => {
    ...
    await page.screenshot({
      path: "playwright-report/screenshots/changelog.png",
      fullPage: true,
    });
  });
  ...
  test("404 not found page", async ({ adminPage: page }) => {
    ...
    await page.screenshot({
      path: "playwright-report/screenshots/404.png",
      fullPage: true,
    });
  });
});
