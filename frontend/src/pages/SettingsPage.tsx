  ...
  return (
    <div>
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="grid gap-6 lg:grid-cols-2">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-lg" style={{ display: "flex", flexDirection: "row", alignItems: "center", gap: "0.5rem" }}><Palette className="h-4 w-4" />Appearance</CardTitle>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-lg" style={{ display: "flex", flexDirection: "row", alignItems: "center", gap: "0.5rem" }}><Bell className="h-4 w-4" />Notifications</CardTitle>
            <CardDescription>Real-time notification preferences</CardDescription>
          </CardHeader>
          <Separator />
          <CardContent className="pt-6">
            <div style={{ display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-between" }}>
              <div>
                ...
                <p className="text-xs text-muted-foreground">Receive notifications when data changes via SSE</p>
              </div>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-lg" style={{ display: "flex", flexDirection: "row", alignItems: "center", gap: "0.5rem" }}><Monitor className="h-4 w-4" />About</CardTitle>
          </CardHeader>
          <Separator />
          <CardContent className="pt-6 space-y-2 text-sm">
            <div style={{ display: "flex", flexDirection: "row", justifyContent: "space-between" }}><span className="text-muted-foreground">Version</span><span className="font-mono font-semibold">2.11.0</span></div>
